...
%Kan currently set to 1 (see MCPLANTS file)// 1: full Kan activity;    0: total inhibition of V3_8;   Kan = 0.1 good 
Kan = p(1); 
%atwbc19 currently set to 1 (see MCPLANTS file)	// 1: Full Activity; 0: Mutant  
atwbc19 = p(2);
%FRD3  currently set to 1(see MCPLANTS file)	// 1: Full Activity; 0: Mutant
FRD3 = p(3);
as1 = p(4);  
as2 = p(5); 
as4 = p(6); 
